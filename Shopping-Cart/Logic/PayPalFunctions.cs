...
public class NVPAPICaller
{
    ...
    public string APIUsername = "Zagorouiko-facilitator_api1.gmail.com";
    private string APIPassword = "2A9EEJSLZQXVLVRJ";
    private string APISignature = "AFcWxV21C7fd0v3bYYYRCpSSRl31A5A.sWJ7.x12o9HVGBQYhWEWaPsa";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        string returnURL = "https://localhost:44365/Checkout/CheckoutReview.aspx";
        string cancelURL = "https://localhost:44365/Checkout/CheckoutCancel.aspx";

        NVPCodec encoder = new NVPCodec();
        encoder["METHOD"] = "SetExpressCheckout";
        encoder["RETURNURL"] = returnURL;
        encoder["CANCELURL"] = cancelURL;
        encoder["BRANDNAME"] = "Shopping Cart Application";
        ...
        using (Shopping_Cart.Logic.ShoppingCartActions myCartOrders = new Shopping_Cart.Logic.ShoppingCartActions())
        {
